...
describe('Example 3 (dual MNIST plus radial PCA plot)', () => {
    it('should have the title: MNIST tSNE embedding',() => {
        ExamplePage.open('/example_3/example_3.html');
        const title = ExamplePage.title;
        assert.strictEqual(title, 'MNIST tSNE 60000 Dual view + radial plot');
    });
