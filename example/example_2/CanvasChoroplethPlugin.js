...
// Implement a CanvasChoroplethPlugin protocol to display area mapped values
ReScatter.protocols.ChoroplethProtocol.impl(CanvasChoroplethPlugin, [], {
    ...
    loadPleth() {
        ...
        this.__fitStageIntoParentContainer();
        // remember to bind this object so that the context is correct on a window resize
        window.addEventListener('resize', this.__fitStageIntoParentContainer.bind(this));
    },
