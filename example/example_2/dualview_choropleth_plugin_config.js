import CanvasChoroplethPlugin from './CanvasChoroplethPlugin.js';
    ...
    Layouts: [
        {
             ...
             */
            dataMaps: [
                {id: 'MNIST60000', filePath:'https://dl.dropboxusercontent.com/s/ny2y23bhy2bmmhp/np60000x784.nrrd.gz'},
            ...
            plots: [
                /** Configuration for the Digits t-SNE plot where the pixels form the dimensions */
                {
                    ...
                    data: {
                        points: '../data/MNIST60000.json',
                        props: '../data/digit_label_60000.json',
                    },
                    format: {
                        id: 'label',
                        symbol: 'label',
