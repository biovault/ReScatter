const _colormapsSequential = [d3.interpolateSpectral, d3.interpolateRdYlBu, d3.interpolatePiYG, d3.interpolatePuOr, d3.interpolateMagma, d3.interpolatePlasma, d3.interpolateViridis, d3.interpolateRdPu, d3.interpolateYlGnBu, d3.interpolateGreys, d3.interpolateBuPu, d3.interpolateYlOrRd, d3.interpolateReds, d3.schemeSet3];

const _colormapNames = ['spectral', 'RdYlBu', 'PiYG', 'PuOr', 'Magma', 'Plasma', 'Viridis', 'RdPu', 'YlGnBu', 'Greys', 'BuPu', 'YlOrRd', 'Reds', 'Qual'];
