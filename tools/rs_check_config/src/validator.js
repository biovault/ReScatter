...
import * as ReScatter from '../rescatter.js' 
...
const siteConfigSchema = Joi.object({
	...
	WidgetPlugins: pluginSchema.description('Declare any user supplied plot widget plugins'),
	// Layout widgets - implementing Z interface
	LayoutTableWidget: pluginSchema.description('Declare any user supplied control widget plugins'), 
	// Site title
